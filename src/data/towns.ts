...
export const towns: Town[] = [
  ...
  },
  {
    ...
    fit:
      'If you’ve collected bids that start at $30,000 before anyone measured anything, our resurfacing line exists precisely for the Bethesda deck whose bones are good. And for full custom builds, our two-visit design process delivers drawings and a fixed price — not a guess.',
    permitNote:
  ...
  },
  {
    ...
    housing:
      'The good news about 2000s framing: most of it was built to modern spans and is an excellent resurfacing candidate. The catch is builder-grade shortcuts — minimal flashing, undersized footings on some additions — which is why every project starts with a structural walk-through we narrate as we go.',
    fit:
