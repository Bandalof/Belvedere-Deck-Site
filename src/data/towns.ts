...
export const towns: Town[] = [
  ...
  },
  {
    ...
    fit:
      'Two patterns dominate our Clarksburg work: upgrading the original 10x12 builder deck to a properly sized composite deck, and first-cycle resurfacing projects on the community\'s older sections. Either way, you get an exact price fast, not a two-week wait.',
    permitNote:
